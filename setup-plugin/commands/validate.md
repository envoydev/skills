...
('Re-run `/project-agent-capabilities`? Validate added 3 skills, so the generated
rule's inventory is short'), never a contentless 'What now?' over a list. The report
